...
class CareerPlan:
    ...
    primary_score: int = 0
    overview: str = ""
    job_search_snapshot: list[dict[str, Any]] = field(default_factory=list)
    strengths: list[str] = field(default_factory=list)
    ...
    recommendation_comparisons: list[dict[str, Any]] = field(default_factory=list)
    role_switch_simulations: list[dict[str, Any]] = field(default_factory=list)
    recommended_projects: list[str] = field(default_factory=list)
    learning_sprints: list[dict[str, str]] = field(default_factory=list)
    resume_surgery: list[dict[str, Any]] = field(default_factory=list)
    ...
    role_comparison_radar: dict[str, Any] = field(default_factory=dict)
    service_loop: list[dict[str, str]] = field(default_factory=list)
    gap_benefit_analysis: list[dict[str, Any]] = field(default_factory=list)
    plan_self_checks: list[dict[str, Any]] = field(default_factory=list)
    similar_cases: list[dict[str, Any]] = field(default_factory=list)
    assessment_tasks: list[str] = field(default_factory=list)
    interview_focus: list[dict[str, Any]] = field(default_factory=list)
